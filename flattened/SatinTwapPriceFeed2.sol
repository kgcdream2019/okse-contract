...
// File contracts/CustomPriceFeed/SatinTwapPriceFeed2.sol

//SPDX-License-Identifier: LICENSED

pragma solidity ^0.7.0;
contract SatinTwapPriceFeed2 is AggregatorV3Interface, Ownable {
    ...
    function setStable(bool _stable0, bool _stable1) public onlyOwner {
        stable0 = _stable0;
        stable1 = _stable1;
    }
    ...
    function getPrice() public view returns (int256) {
        address poolAddress0 = IBaseV1Router01(router).pairFor(
            TOKEN,
            middleToken,
            stable0
        );
        uint[] memory prices0 = IBaseV1Pair(poolAddress0).prices(
            TOKEN,
            testAmountsIn,
            1
        );
        address poolAddress1 = IBaseV1Router01(router).pairFor(
            middleToken,
            USDC,
            stable1
        );
        uint[] memory prices1 = IBaseV1Pair(poolAddress1).prices(
            TOKEN,
            testAmountsIn,
            1
        );
        uint256 quoteAmount = prices1[0];
