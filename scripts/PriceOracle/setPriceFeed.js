...
async function main() {
    ...
    if (network.name === "bscmainnet") {
        ...
        asset = "0xd17479997f34dd9156deef8f95a52d81d265be9c"; // USDD
        priceFeed = "0x51c78c299C42b058Bf11d47FbB74aC437C6a0c8C"; // Chainlink
        ...
        chainId = 324;
        const weth = "0x5AEa5775959fBC2557Cc8789bC1bf90A239D9a91"; // weth
        asset = weth
